...
public extension Sequence {
  ...
  @inlinable func sorted<Value: Comparable>(by keyPath: KeyPath<Element, Value>) -> [Element] {
  ...
  @inlinable func sorted<Value>(
    by keyPath: KeyPath<Element, Value>, using areInIncreasingOrder: (Value, Value) throws -> Bool
  ) rethrows -> [Element] {
    try self.sorted {
